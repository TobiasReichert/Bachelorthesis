...
/**
 * This inteface is a Actionlistener.
 * You can implement it and give the implementeion to the MDBS.
 * The MDBS will call it if a synchronisation is complete.
 * 
...
public interface SyncListener extends EventListener {
    ...
    void syncPerformed(int from, boolean pass);
